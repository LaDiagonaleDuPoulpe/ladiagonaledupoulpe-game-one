...
import BossUnit from '../prefabs/battle/BossUnit';
...
class BattleScene extends JSONLevelScene {
    ...
    end_battle () {
        ...
        firebase.database().ref('users/' + firebase.auth().currentUser.uid + '/party_data').set(this.cache.game.party_data).then(this.back_to_world.bind(this));
    }
